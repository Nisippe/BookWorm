...
<form name="recPassForm" method="post" action="RichiediAttivazione">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <p></p>
                    <div class="d-flex justify-content-center">
                        <input type="submit" class="justify-content-center bottone3"  value="RICHIEDI ATTIVAZIONE">
                    </div>
                </div>
            </div>
        </div>
